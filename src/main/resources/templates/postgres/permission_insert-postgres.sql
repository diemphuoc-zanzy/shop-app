...
INSERT INTO permissions (name, description, resource, method, action, role_id) VALUES ('VIEW_CATEGORY_"SELLER"', 'Permission to view ', '/categories/gets', 'GET', 'VIEW', 2);
-- INSERT INTO permissions (name, description, resource, method, action, role_id) VALUES ('VIEW_CATEGORY_"SELLER"', 'Permission to view ', '/categories/gets/**', 'GET', 'VIEW', 2);

INSERT INTO permissions (name, description, resource, method, action, role_id) VALUES ('VIEW_CATEGORY_CUSTOMER', 'Permission to view ', '/categories/gets', 'GET', 'VIEW', 3);
-- INSERT INTO permissions (name, description, resource, method, action, role_id) VALUES ('VIEW_CATEGORY_CUSTOMER', 'Permission to view ', '/categories/gets/**', 'GET', 'VIEW', 3);

INSERT INTO permissions (name, description, resource, method, action, role_id) VALUES ('VIEW_CATEGORY_MODERATOR', 'Permission to view ', '/categories/gets', 'GET', 'VIEW', 4);
-- INSERT INTO permissions (name, description, resource, method, action, role_id) VALUES ('VIEW_CATEGORY_MODERATOR', 'Permission to view ', '/categories/gets/**', 'GET', 'VIEW', 4);
